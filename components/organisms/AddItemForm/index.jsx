...
import { getLocationItemByBrIdx,getListLocationItem  } from "../../../services/locationitem";
...
export default function AddItemForm() {
  ...
  const onSubmit = async () => {
    ...
    const selectedCategory = selectCategory === null ? null : selectCategory.value;
  ...
  return (
    <Fragment>
      <div className="form-row">
        ...
        <div className="col-md-12 mb-3">
          <label>
            Biaya <sup className={styles["text-required"]}>*</sup>
          </label>
          <input
            type="number"
            className="form-control"
        ...
        <div className="col-md-12 mb-3">
          <label>
            Harga <sup className={styles["text-required"]}>*</sup>
          </label>
          <input
            type="number"
            className="form-control"
